<?php
	...
	if($kwd != ''){
		...
		//로그포맷
		$logInfo = getLogInfo("ReVu", "블로그", "", $kwd, $pageNum, $srchParam->getReSrchFlag(), $orderNm, $srchParam->getRecKwd());
		...
		$orderBy = "order by userpoint desc";

		dcSubmitQuery($scn,$query,$logInfo,$hilightTxt,$orderBy,$pageNum,$pageSize,true,$rsbBlog,1,4);	
