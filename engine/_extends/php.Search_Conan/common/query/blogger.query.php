<?php
	...
	//변수선언 
	$scn = $serverInfo['SCN_CATEGORY4'][0]['value'];	
	...
	if($kwd != ''){
		...
		//로그포맷
		$logInfo = getLogInfo("ReVu", "블로거", "", $kwd, $pageNum, $srchParam->getReSrchFlag(), $orderNm, $srchParam->getRecKwd());
		...
		dcSubmitQuery($scn,$query,$logInfo,$hilightTxt,$orderBy,$pageNum,$pageSize,true,$rsbBlogger,1,4);	
