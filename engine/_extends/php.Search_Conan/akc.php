<?php
	require(_DIR_EXTENDS."/php.Search_Conan/lib/DOCRUZER.php");
	require(_DIR_EXTENDS."/php.Search_Conan/lib/util/DCConfig.php");
			
	//POST Method를 사용하기 위해서는 UTF-8을 EUC-KR로 변환이 필요하다.
	//참고 : ICONV를 이용.
