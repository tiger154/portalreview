...
abstract class Rememberme_Storage_DB implements Rememberme_Storage_StorageInterface {
  ...
  public function getTwitColumn() {
    return $this->twitColumn;
  }

  public function setTwitColumn($twitColumn) {
    $this->twitColumn = $twitColumn;
    return $this;
  }

  public function getFbColumn() {
    return $this->fbColumn;
  }

  public function setFbColumn($fbColumn) {
