<?php /* Template_ 2.2.4 2012/09/18 12:45:20 /www/revu39/engine/view/V3.9/join/join.sns.htm 000005436 */ ?>
...
<table width="100%" border="0" cellspacing="0">
	...
	<tr> 
         ...
         <td class=block_text2>
            ...
            &nbsp; <span class=common11_text><img style="MARGIN-BOTTOM: -6px" id="checkIDBtn" class="btn" title="중복확인" alt="중복확인" 
      src="/images/common/but/but_g_repeat.gif" />&nbsp; * SNS ID와 더블어 레뷰에서 사용하실 ID를 입력해주세요.</span></td>
    </tr>
    <tr>
         ...
         <td class=block_text2>
					...
					&nbsp; 
					<span class=common11_text>* 비밀번호는 6자리 이상으로 입력해주세요.</span></td>
    </tr>
     <tr>
