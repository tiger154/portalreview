<?php /* Template_ 2.2.4 2012/09/24 14:27:36 /www/revu39/engine/view/V3.9/frontier/frontier.detailview2.htm 000018518 */ 
...
<?php echo $TPL_VAR["scroll"]?>
      ...
      <div id="frontier_view_warp">
		...
		<!-- 상단 정보 추가-->
		<div class="frontier_view_info">
			<!-- 이벤트 썸네일 -->
			<div class="thum">
				<img src="<?php echo $TPL_VAR["top_thumbimg"]?>">
				<div class="time"><span><?php echo $TPL_VAR["remain_message"]?></span></div>
			</div>
			<!-- 이벤트 상세내용 -->
			<div class="info">
				<p class="title"><?php echo $TPL_VAR["subject"]?></p>
				<p>
					<label>상품 : </label><strong><?php echo $TPL_VAR["frproduct"]?></strong>
				</p>
				<p>
					<label>분류 : </label><?php echo $TPL_VAR["cate"]?>

				</p>
				<p>
					<label>모집 : </label><?php echo $TPL_VAR["jstart_date"]?> ~ <?php echo $TPL_VAR["jend_date"]?>

				</p>
				<p>
					<label>인원 : </label><?php echo $TPL_VAR["peoplelimit"]?>명
				</p>
				<p>
					<label>발표 : </label><?php echo $TPL_VAR["noticedate"]?>

				</p>
				<p>
					<label>리뷰 : </label><?php echo $TPL_VAR["due_sdate"]?> ~ <?php echo $TPL_VAR["due_edate"]?>

				</p>
				<div class="sns">
					<span>프론티어를 SNS로 공유하세요. 당첨확률이 높아집니다.</span>
					<ul class="sns">
						<li class="twitter"><!-- twitter like 버튼 -->
						...
						<li class="facebook"><!-- facebook like 버튼 -->
							<div id="fb-root"></div>
							<script>(function(d, s, id) {
							  var js, fjs = d.getElementsByTagName(s)[0];
							  if (d.getElementById(id)) return;
							  js = d.createElement(s); js.id = id;
							  js.src = "//connect.facebook.net/ko_KR/all.js#xfbml=1&appId=189402831149686";
							  fjs.parentNode.insertBefore(js, fjs);
							}(document, 'script', 'facebook-jssdk'));</script>
							<div class="fb-like" style="padding:0;"data-href="<?php echo $TPL_VAR["nowPageUrl"]?>" data-send="false" data-layout="button_count" data-width="90" data-show-faces="true"></div>
						</li>
					</ul>
				</div>
			</div>
...
<?php }?>
	...
	<!-- 프론티어 기본정보박스 끝 -->
	<div style="width:714px; height:88px;"></div>
