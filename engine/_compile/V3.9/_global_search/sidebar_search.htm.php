<?php /* Template_ 2.2.4 2012/06/04 09:20:41 /www/revu39/engine/view/V3.9/_global_search/sidebar_search.htm 000007721 */ 
$TPL_popularKwdList_1=empty($TPL_VAR["popularKwdList"])||!is_array($TPL_VAR["popularKwdList"])?0:count($TPL_VAR["popularKwdList"]);
...
//-->
			...
			<div class="rank">
				...
				<ul>
<?php if($TPL_popularKwdList_1){foreach($TPL_VAR["popularKwdList"] as $TPL_V1){?>
				<li class="<?php echo $TPL_V1["dp"]?>">
				<a href="javascript:goKwd('<?php echo $TPL_V1["ppk"]?>');">
					<em><?php echo $TPL_V1["no"]?></em><?php echo $TPL_V1["ppk"]?>

					<span class="<?php echo $TPL_V1["tagInfo"]?>">
						<span class="rnum">
<?php if($TPL_V1["tagNum"]=="new"){?>&nbsp;<?php }else{?><?php echo $TPL_V1["tagNum"]?><?php }?>
						</span>
...
<?php }}?>
				...
				<p class="rank_time"><span><?php echo $TPL_VAR["now_time"]?></span></p>
			</div>
			<!-- // pop_keyword -->
			<hr>
...
<?php if($TPL_I1< 3){?>
							<li class="rnp"><a href="javascript:common.socialbar(<?php echo $TPL_V1["rno"]?>)"><em><?php echo $TPL_I1+ 1?></em><?php echo $TPL_V1["title"]?></a></li>	
<?php }else{?>
							<li class="rng"><a href="javascript:common.socialbar(<?php echo $TPL_V1["rno"]?>)"><em><?php echo $TPL_I1+ 1?></em><?php echo $TPL_V1["title"]?></a></li>	
<?php }?>
<?php }}?>					
				</ul>
				<p class="rank_date"><button class="prev_week" onclick="javascript:common.weekBestChange(<?php echo $TPL_VAR["bestPrev_wno"]?>)"><span class="hiding">이전 주 보기<span></button><em><?php echo $TPL_VAR["bestDate"]["sdate"]?> - <?php echo $TPL_VAR["bestDate"]["edate"]?></em><button class="next_week" onclick="javascript:common.weekBestChange(<?php echo $TPL_VAR["bestNext_wno"]?>)"><span class="hiding">다음주 보기<span></button></p>
			</div>
			<!-- // best_revu -->
			<hr>
